        ...
        WorldInitializeRequest: {
          ...
          properties: {
            saveKey: {
              ...
              maxLength: 200,
              pattern: "^[^\\r\\n\\s](?:[^\\r\\n]*[^\\r\\n\\s])?$",
              description: "Unique idempotency key for this confirmed character and new-world initialization.",
            },
            character: {
              type: "object",
              required: ["name"],
              properties: {
                ...
                relationships: { type: "array", items: { oneOf: [{ type: "string" }, freeformObject] } },
              },
              additionalProperties: true,
            },
            opening: {
              ...
              properties: {
                ...
                time: { type: "string" },
                premise: { type: "string" },
                knownAbilities: { type: "array", items: { oneOf: [{ type: "string" }, freeformObject] } },
                knownWorldFacts: { type: "array", items: { oneOf: [{ type: "string" }, freeformObject] } },
                promises: { type: "array", items: { oneOf: [{ type: "string" }, freeformObject] } },
                visibleClue: { type: "string" },
                choices: { type: "array", items: { oneOf: [{ type: "string" }, freeformObject] } },
                contracts: { type: "array", items: { oneOf: [{ type: "string" }, freeformObject] } },
                hiddenOrigin: { type: "string" },
